...
const CobaBayar3x = () => {
  ...
  <div style={{ width: "55%", backgroundColor: "#f8f2f2", marginBottom: "20px", borderRadius: "20px", display: "flex", alignItems: "center" }}>
    ...
    />
        ...
        <Link to={'/carabayar3'} className="btn"><h6 style={{color:"#010101", margin:"3px"}}>ATM</h6></Link>
        <h6 style={{color:"#010101", margin:"8px"}}>M-Banking</h6>
          ...
          <Link to={'/bayar'} className="btn btn-primary w-70">
            Kembali
          </Link>
        </div>
        <div></div>
